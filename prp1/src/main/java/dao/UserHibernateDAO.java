...
public class UserHibernateDAO implements UserDAO {
    ...
    @Override
    public void updateUser(int id,String login, String password, String role, String name, int age) throws DBException {
        Session session = sessionFactory.openSession();
        String hql = "Update User SET login = :loginParam , password = :passwordParam , role = :roleParam, " +
                "name = :nameParam , age = :ageParam " +
                "WHERE id = :idParam";
        Transaction transaction = session.beginTransaction();
